...
const UserProfileWrapper = () => {
  ...
  return (
    <>
      <div className="w-full  bg-white h-20 text-start px-4 md:px-20 pt-5">
        <div className="mb-8">
          <h2 className="text-2xl md:text-3xl font-semibold">Account</h2>
          <p className="text-md md:text-lg text-gray-600">{user?.firstName}</p>
        </div>
      </div>
      <div className="flex flex-col md:flex-row min-h-full bg-gray-100">
        {/* Sidebar */}
        <div className="w-full min-h-screen md:w-1/6 bg-white p-4 shadow-lg px-4 md:pl-20 md:pt-10">
          ...
          <div className="mt-8">
            <button onClick={openModal}  className="flex items-center text-gray-700 hover:text-red-500">
